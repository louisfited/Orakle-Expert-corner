...
export const fr = {
  ...
  adjustMedications: 'Quels ajustements, le cas échéant, apporteriez-vous aux médicaments existants du patient ?',
  ...
  dontSelectAnyMedicationToProceed: 'Veuillez ne sélectionner aucun médicament pour continuer.',
  addNonMedicationOrders: 'Ajouter des ordonnances non médicamenteuses',
  pleaseSelect: 'Veuillez sélectionner',
  selectOneMedication: 'Veuillez sélectionner un médicament pour passer à la page suivante.',
  selectAdditionalOrders: 'Sélectionnez les commandes supplémentaires appropriées pour le patient.',
  ...
  selectAppropriate: 'Sélectionnez les ordonnances supplémentaires appropriées pour le patient.',
  decisions: 'Décisions',
