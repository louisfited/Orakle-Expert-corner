...
export const en = {
  ...
  adjustMedications: 'What adjustments, if any, would you make to the patient’s existing medications?',
  ...
  selectOneMedication: 'Please select 1 medication to proceed to the next page.',
  selectAdditionalOrders: 'Select appropriate additional orders for the patient.',
