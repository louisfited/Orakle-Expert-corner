...
export const MedicalCaseCard = ({ medicalCase, hasDescription }: MedicalCaseCardProps) => {
  ...
  return (
    <>
      <div
        ref={cardRef}
        className="flex flex-col w-[343px] md:w-[348px] xl:w-[270px] 2xl:w-[395px] max-w-[395px] transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:z-50 group overflow-visible hover:rounded-2xl hover:bg-white relative"
